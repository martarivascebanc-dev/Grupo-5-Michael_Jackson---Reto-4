...
public class VentanaPrincipal {
    ...
    public static void main(String[] args) {
        ...
        JButton agregarButton = new JButton("Eliminar");
        agregarButton.setBounds(775, 210, 175, 50);
        agregarButton.setBorder(BorderFactory.createLineBorder(Color.BLACK, 2));
        agregarButton.setBackground(Color.CYAN);
